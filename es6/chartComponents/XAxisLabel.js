...
function (_React$Component) {
  _inherits(XAxisLabel, _React$Component);

  function XAxisLabel() {
    _classCallCheck(this, XAxisLabel);

    return _possibleConstructorReturn(this, _getPrototypeOf(XAxisLabel).apply(this, arguments));
  }

  _createClass(XAxisLabel, [{
    key: "render",
